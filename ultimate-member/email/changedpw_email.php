...
<div><img src="https://ap1.arrenberg.studio/wp-content/themes/quartiersplattform/assets/mail/registrieren.png" alt="Arrenberg Logo" width="200" height="200" /></div>
<div> </div>
<br>
...
<div> </div>
<div>
<div class="text" style="width: 60%; display: inline-block; line-height: 24px;">Dein Passwort wurde vor kurzem geändert.Sollte diese Änderung nicht von dir gewesen sein, kontaktiere uns bitte umgehend.</div>
<p>&nbsp;</p>
</div>
<div style="padding: 0 30px 30px 30px;">
<div> </div>
<div style="padding: 10px 0 50px 0; text-align: center;"><a class="shadow" style="background: #0091ff; color: #fff; padding: 20px 30px; text-decoration: none; border-radius: 20px; letter-spacing: 0.3px; font-family: 'Open Sans', Helvetica,Arial; margin-top: 100px; box-shadow: 0 1px 2px rgba(0, 0, 0, 0.07), 02px 4px rgba(0, 0, 0, 0.07), 0 4px 8px rgba(0, 0, 0, 0.07), 0 8px 16px rgba(0,0, 0, 0.07), 0 16px 32px rgba(0, 0, 0, 0.07), 0 32px 64px rgba(0, 0, 0, 0.07); font-size: 16px;" href="{user_account_link}">Sieh dir dein Konto an </a></div>
<div style="padding: 20px;">Sollten Probleme auftreten wende dich bitte per Mail an uns. {admin_email}</div>
</div>
