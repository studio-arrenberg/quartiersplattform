...
<style>
  ...
  font-size: 16px; } 
  .content { padding: 5%; text-align: center; vertical-align:
  center; position: relative; color: #666666; font-family: "Open Sans", Helvetica,
  Arial; 
  font-size: 14px; background-color: white; display: inline-block;
...
<div class="mail" style="text-align: center;vertical-align: center;background-color: #f7f7f7;padding: 5% 5%;">
  ...
  Arial;font-size: 14px;background-color: white;display: inline-block;border-radius: 50px;">
    <div>
      <img src="https://arrenberg.app/wp-content/themes/quartiersplattform/assets/mail/registrieren.png" alt="Arrenberg Logo" width="200" height="200">
    </div>
    <div>
      <span style="
          font-size: 26px;
    ...
    <div>
      <div class="text" style="width: 60%;display: inline-block;line-height: 24px;">
        <span>Dein Passwort wurde vor kurzem geändert.Sollte diese Änderung nicht
          von dir gewesen sein, kontaktiere uns bitte umgehend.
      </span></div>
      <p></p>
    </div>
    ...
    <div style="padding: 0 30px 30px 30px">
      <div> </div>
      <div style="padding: 10px 0 50px 0; text-align: center" class="">
  ...
  2px 4px rgba(0, 0, 0, 0.07), 0 4px 8px rgba(0, 0, 0, 0.07), 0 8px 16px rgba(0,
  0, 0, 0.07), 0 16px 32px rgba(0, 0, 0, 0.07), 0 32px 64px rgba(0, 0, 0, 0.07);font-size: 12px;" href="{user_account_link}">Sieh dir dein Konto an
        </a>
      </div>
