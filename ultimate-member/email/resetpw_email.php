...
<style>.shadow { box-shadow: 0 1px 2px rgba(0, 0, 0, 0.07), 0
...
100%; padding: 4%; font-size: 14px; line-height: 18px; } .column img {
max-width: 200px; } 
...
.footer { text-align: center; margin-top: 5%; } a {
...
2px 4px rgba(0, 0, 0, 0.07), 0 4px 8px rgba(0, 0, 0, 0.07), 0 8px 16px rgba(0,
0, 0, 0.07), 0 16px 32px rgba(0, 0, 0, 0.07), 0 32px 64px rgba(0, 0, 0, 0.07);font-size: 12px;" href="{password_reset_link}">Passwort zurücksetzen
        </a>
      </div>
