...
<a class="button is-primary" href="<?php echo get_bloginfo('template_url') .'/assets/generated/calendar-files/'.$kb_file_name.'.ics' ?>" target="_self"><?php _e('Termin im Kalender speichern','quartiersplattform'); ?></a>