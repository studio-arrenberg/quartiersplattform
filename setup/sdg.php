...
function register_sdg() {
	...
	for ($i = 0; $i < count($sdgs); $i++) {
		...
		$title = wp_strip_all_tags( $sdgs[$i]['title'] );
...
$translate_sdgs = array(
	0 => array('title' => __('Keine Armut','quartiersplattform'), 'color' => '#E5243B', 'goal' => '1', 'class' => 'bg_red', 'slogan' => __('Armut in all ihren Formen und überall beenden','quartiersplattform'), 'content' => __('Es gehört zu den zentralen Entwicklungszielen bis 2030 die extreme Armut auf der Welt zu beseitigen. Allerdings wird extreme Armut mit einem gegenwärtigen Grenzwert von 1,25 US-Dollar, die pro Person pro Tag zur Verfügung stehen, definiert. Kritiker halten diesen Wert für deutlich zu niedrig.','quartiersplattform')), 
	1 => array('title' => __('Keine Hungersnot','quartiersplattform'),'color' => '#DDA63A','goal' => '2', 'class' => 'bg_grey', 'slogan' => __('Den Hunger beenden, Ernährungssicherheit und eine bessere Ernährung erreichen und eine nachhaltige Landwirtschaft fördern','quartiersplattform'), 'content' => __('Alle Menschen sollen bis 2030 „ganzjährig Zugang zu sicheren, nährstoffreichen und ausreichenden Nahrungsmitteln haben“. Obwohl bereits heute genügend Nahrungsmittel zur Verfügung stehen, haben immer noch nicht alle Menschen Zugang zu ihnen. Ebenso sollen alle Formen der Mangelernährung beseitigt sowie die landwirtschaftliche Produktivität und die Einkommen der kleinen Nahrungsmittelproduzenten verdoppelt werden.','quartiersplattform')),
	2 => array('title' => __('Gute Gesundheitsversorgung','quartiersplattform'),'color' => '#4C9F38','goal' => '3', 'class' => 'bg_green', 'slogan' => __('Ein gesundes Leben für alle Menschen jeden Alters gewährleisten und ihr Wohlergehen fördern','quartiersplattform'), 'content' => __('Bis 2030 soll die weltweite Müttersterblichkeit auf unter 70 je 100.000 Lebendgeburten sinken. Vermeidbare Todesfälle bei Neugeborenen und Kindern unter fünf Jahren sollen verhindert werden. In den Zielvorgaben sind die Beseitigung der Aids-, Tuberkulose- und Malaria-Epidemien sowie der vernachlässigten Tropenkrankheiten von besonderer Bedeutung, ebenso der Zugang zu einer Gesundheitsversorgung für alle.','quartiersplattform')),
	3 => array('title' => __('Hochwertige Bildung','quartiersplattform'),'color' => '#C5192D','goal' => '4', 'class' => 'bg_red-dark', 'slogan' => __('Inklusive, gleichberechtigte und hochwertige Bildung und Möglichkeiten lebenslangen Lernens für alle fördern','quartiersplattform'), 'content' => __('Die wichtigste Zielvorgabe besagt, dass bis 2030 sichergestellt werden soll, „dass alle Mädchen und Jungen gleichberechtigt eine kostenlose und hochwertige Grund- und Sekundarschulbildung abschließen“. In weiteren Zielvorgaben werden Maßstäbe für Vorschulerziehung sowie Hochschul- und Berufsbildung formuliert.','quartiersplattform')),
	4 => array('title' => __('Gleichberechtigung der Geschlechter','quartiersplattform'),'color' => '#FF3A21','goal' => '5', 'class' => 'bg_orange-dark', 'slogan' => __('Geschlechtergleichstellung erreichen und alle Frauen und Mädchen zur Selbstbestimmung befähigen','quartiersplattform'), 'content' => __('Zu den wesentlichen Anliegen gehört, alle Formen der Diskriminierung von Frauen und Mädchen zu beenden und die Gewalt gegen sie zu beseitigen. Weitere Zielvorgaben befassen sich mit individuellen Formen der geschlechtsspezifischen Diskriminierung, wie beispielweise Zwangsheirat, fehlende Chancengleichheit bei dem Erlangen von Führungspositionen und ungleiche Rechte auf wirtschaftliche Ressourcen.','quartiersplattform')),
	5 => array('title' => __('Sauberes Wasser und sanitäre Einrichtungen','quartiersplattform'),'color' => '#26BDE2','goal' => '6', 'class' => 'bg_blue-cyan', 'slogan' => __('Verfügbarkeit und nachhaltige Bewirtschaftung von Wasser und Sanitärversorgung für alle gewährleisten','quartiersplattform'), 'content' => __('Bis 2030 soll der Zugang zu einwandfreiem und bezahlbarem Trinkwasser sowie einer angemessenen und gerechten Sanitärversorgung für alle verwirklicht werden. In weiteren Zielvorgaben geht es u.a. um die Verbesserung der Wasserqualität, die Effizienz der Wassernutzung und den Schutz wasserverbundener Ökosysteme.','quartiersplattform')),
	6 => array('title' => __('Erneuerbare Energien','quartiersplattform'),'color' => '#FCC30B','goal' => '7', 'class' => 'bg_yellow', 'slogan' => __('Zugang zu bezahlbarer, verlässlicher, nachhaltiger und moderner Energie für alle sichern','quartiersplattform'), 'content' => __('Der allgemeine Zugang zu Energiedienstleistungen soll bis 2030 gesichert werden. Dabei soll der Anteil erneuerbarer Energie deutlich erhöht werden. Gleichzeitig soll die Steigerungsrate der Energieeffizienz verdoppelt werden.','quartiersplattform')),
	7 => array('title' => __('Gute Arbeitsplätze und wirtschaftliches Wachstum','quartiersplattform'),'color' => '#A21942','goal' => '8', 'class' => 'bg_violett', 'slogan' => __('Dauerhaftes, breitenwirksames und nachhaltiges Wirtschaftswachstum, produktive Vollbeschäftigung und menschenwürdige Arbeit für alle fördern','quartiersplattform'), 'content' => __('Großes Gewicht wird auf Fragen des nachhaltigen Wirtschaftswachstums und der Beschäftigung gelegt. Ein hohes Wirtschaftswachstum wird vor allem in den am wenigsten entwickelten Ländern für erforderlich gehalten, mindestens 7 % im Jahr. Für alle Länder werden höhere wirtschaftliche Produktivität und Ressourceneffizienz angestrebt. Andere Zielvorgaben befassen sich mit menschenwürdigen Arbeitsplätzen, einer produktiven Vollbeschäftigung, der Beendigung von Zwangsarbeit, Sklaverei und Menschenhandel sowie dem Schutz der Arbeitsrechte.','quartiersplattform')),
	8 => array('title' => __('Innovation und Infrastruktur','quartiersplattform'),'color' => '#FD6925','goal' => '9', 'class' => 'bg_orange', 'slogan' => __('Eine widerstandsfähige Infrastruktur aufbauen, breitenwirksame und nachhaltige Industrialisierung fördern und Innovation unterstützen','quartiersplattform'), 'content' => __('Es wird angestrebt, eine hochwertige, verlässliche, nachhaltige und widerstandsfähige Infrastruktur aufzubauen, um so wirtschaftliche Entwicklung und menschliches Wohlergehen zu unterstützen. Insbesondere in Entwicklungsländern sollen kleine Industriebetriebe einen besseren Zugang zu Finanzdienstleistungen, Wertschöpfungsketten und Märkten erhalten.','quartiersplattform')),
	9 => array('title' => __('Weniger Ungleichheiten','quartiersplattform'),'color' => '#A21942','goal' => '10', 'class' => 'bg_pink', 'slogan' => __('Ungleichheit in und zwischen Ländern verringern','quartiersplattform'), 'content' => __('Eine wichtige Zielvorgabe lautet: „Bis 2030 ein über dem nationalen Durchschnitt liegendes Einkommenswachstum der ärmsten 40 Prozent der Bevölkerung zu erreichen.“ Angestrebt wird außerdem u. a. eine „verstärkte Mitsprache der Entwicklungsländer bei der Entscheidungsfindung in den globalen internationalen Wirtschafts- und Finanzinstitutionen“.','quartiersplattform')),
	10 => array('title' => __('Nachhaltige Städte und Gemeinden','quartiersplattform'),'color' => '#FD9D24','goal' => '11', 'class' => 'bg_orange-light', 'slogan' => __('Städte und Siedlungen inklusiv, sicher, widerstandsfähig und nachhaltig gestalten','quartiersplattform'), 'content' => __('„Bis 2030 den Zugang zu angemessenem, sicherem und bezahlbarem Wohnraum und zur Grundversorgung für alle sicherstellen und Slums sanieren.“ Dazu gehören u. a. ein Verkehrssystem für alle, eine partizipative Siedlungsplanung, ein verbesserter Katastrophenschutz, eine Verminderung der Umweltbelastung und eine größere Widerstandsfähigkeit gegenüber den Folgen des Klimawandels.','quartiersplattform')),
	11 => array('title' => __('Nachhaltiger Konsum und Produktion','quartiersplattform'),'color' => '#BF8B2E','goal' => '12', 'class' => 'bg_brown', 'slogan' => __('Nachhaltige Konsum- und Produktionsmuster sicherstellen','quartiersplattform'), 'content' => __('Zur Umsetzung dieses Ziels „sind an der Spitze die entwickelten Länder“ gefordert, während die Entwicklungsländer entsprechend ihrem Entwicklungsstand und ihren Kapazitäten Maßnahmen ergreifen sollen. Als wichtige Themen werden dabei u. a. die nachhaltige Bewirtschaftung und effiziente Nutzung der natürlichen Ressourcen, eine Halbierung der Nahrungsmittelverschwendung und ein umweltverträglicher Umgang mit Chemikalien und Abfällen aufgeführt. Angestrebt wird auch eine allmähliche Abschaffung der schädlichen Subventionen für fossile Brennstoffe.','quartiersplattform')),
	12 => array('title' => __('Maßnahmen zum Klimaschutz','quartiersplattform'),'color' => '#3F7E44','goal' => '13', 'class' => 'bg_green-dark', 'slogan' => __('Umgehend Maßnahmen zur Bekämpfung des Klimawandels und seiner Auswirkungen ergreifen','quartiersplattform'), 'content' => __('Es gilt, wird in einer Zielvorgabe formuliert, „die Widerstandskraft und die Anpassungsfähigkeit gegenüber klimabedingten Gefahren und Naturkatastrophen in allen Ländern“ zu stärken. Dafür müssen Klimaschutzmaßnahmen in die nationalen Politiken, Strategien und Planungen einbezogen werden. Ausdrücklich wird an die Verpflichtung der entwickelten Länder erinnert, ab 2020 jährlich 100 Milliarden US-Dollar für den Klimaschutz in Entwicklungsländern aufzubringen.','quartiersplattform')),
	13 => array('title' => __('Leben unter dem Wasser','quartiersplattform'),'color' => '#0A97D9','goal' => '14', 'class' => 'bg_blue-light', 'slogan' => __('Ozeane, Meere und Meeresressourcen im Sinne nachhaltiger Entwicklung erhalten und nachhaltig nutzen','quartiersplattform'), 'content' => __('Bis 2025 sollen alle Arten der Meeresverschmutzung gestoppt oder erheblich verringert werden. Außerdem sollen die Meeres- und Küstenökosysteme nachhaltig bewirtschaftet und die Versauerung der Ozeane bekämpft werden. Angestrebt werden auch eine wirksame Regelung der Fangtätigkeit und die Beendigung der Überfischung.','quartiersplattform')),
	14 => array('title' => __('Leben an Land','quartiersplattform'),'color' => '#56C02B','goal' => '15', 'class' => 'bg_green-light', 'slogan' => __('Landökosysteme schützen wiederherstellen und ihre nachhaltige Nutzung fördern, Wälder nachhaltig bewirtschaften, Wüstenbildung bekämpfen, Bodendegradation beenden und umkehren und dem Verlust der biologischen Vielfalt ein Ende setzen','quartiersplattform'), 'content' => __('Bis 2020 soll eine nachhaltige Nutzung der Land- und Binnensüßwasser-Ökosysteme sowie der Wälder erreicht werden. Ebenso werden eine Bekämpfung der Wüstenbildung und die Erhaltung der Bergökosysteme angestrebt. Um den Verlust der biologischen Vielfalt zu beenden, sollen bedrohte Arten geschützt und ihr Aussterben verhindert werden.','quartiersplattform')),
	15 => array('title' => __('Frieden und Gerechtigkeit','quartiersplattform'),'color' => '#00689D','goal' => '16', 'class' => 'bg_blue', 'slogan' => __('Friedliche und inklusive Gesellschaften für eine nachhaltige Entwicklung fördern, allen Menschen Zugang zur Justiz ermöglichen und leistungsfähige, rechenschaftspflichtige und inklusive Institutionen auf allen Ebenen aufbauen','quartiersplattform'), 'content' => __('Um dieses Ziel zu erreichen, sollen alle Formen von Gewalt verringert und Rechtsstaatlichkeit gewährleistet werden, wozu auch der Aufbau leistungsfähiger Institutionen gehört. Ebenso gilt es, bis 2030 die illegalen Finanz- und Waffenströme deutlich zu verringern.','quartiersplattform')),
	16 => array('title' => __('Partnerschaften zur Erreichung der Ziele','quartiersplattform'),'color' => '#19486A','goal' => '17', 'class' => 'bg_blue-dark', 'slogan' => __('Umsetzungsmittel stärken und die Globale Partnerschaft für nachhaltige Entwicklung stärken','quartiersplattform'), 'content' => __('Die Industrieländer werden aufgefordert, ihre Zusagen von öffentlicher Entwicklungshilfe einzuhalten, insbesondere die Bereitstellung von 0,7 % ihres Bruttonationaleinkommens für diese Aufgaben. Gefördert werden soll eine verstärkte Nord-Süd- und Süd-Süd-Zusammenarbeit im Bereich Wissenschaft, Technologie und Innovation. Zu den Zielvorgaben gehört es auch, ein gerechtes multilaterales Handelssystem unter dem Dach der Welthandelsorganisation zu schaffen.','quartiersplattform'))
);
